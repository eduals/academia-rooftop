...
(function() {
    ...
    var module = {
              ...
              <div class="flex flex-col lg:flex-row lg:items-start lg:space-x-8">
                ...
                <div class="flex-grow">
                  <form id="perfil-form" class="space-y-6">
                    ...
                    <!-- Endereço de Entrega -->
                    <div>
                      <label for="endereco_de_entrega_do_material_impresso" class="block text-sm font-medium text-slate-700 mb-2">
                        Endereço de Entrega do Material Impresso
                      </label>
                      <textarea 
                        id="endereco_de_entrega_do_material_impresso" 
                        name="endereco_de_entrega_do_material_impresso" 
                        rows="3"
                        class="form-input"
                        placeholder="Digite o endereço completo para entrega de materiais impressos"
                      >${contato.endereco_de_entrega_do_material_impresso || ''}</textarea>
                    </div>
      ...
      handleFormSubmit: function(e) {
        ...
        if (data.endereco_de_entrega_do_material_impresso !== this.currentContato.endereco_de_entrega_do_material_impresso) {
          updates.push({ field: 'endereco_de_entrega_do_material_impresso', value: data.endereco_de_entrega_do_material_impresso });
        }
