  ...
  <path d="M9 11H3v5a2 2 0 002 2h4v-7zM11 18h4a2 2 0 002-2v-5h-6v7z"></path>
    ...
    getFranquiaStatusInfo: function (stage) {
      var franquiaStatusMap = {
        ...
        '1207696559': { label: '2 Reunião marcada', color: 'bg-blue-100 text-blue-800' },
        '1207696560': { label: '2 Reunião realizada', color: 'bg-blue-100 text-blue-800' },
    ...
    getAllFranquiaStatuses: function () {
      return [
        ...
        { code: '1207696559', label: '2 Reunião marcada', color: 'bg-blue-100 text-blue-800' },
        { code: '1207696560', label: '2 Reunião realizada', color: 'bg-blue-100 text-blue-800' },
